...
const newColor = () => {
	...
	_data.gameSequence.push(Math.floor(Math.random() * 4)); /*essa linha de código  vai me dar um numero arredondado p baixo entre 1 e 3 e o push sempre vai acrescentar valor */
	_data.score++;
